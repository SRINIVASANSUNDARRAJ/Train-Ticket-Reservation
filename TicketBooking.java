...
public class TicketBooking {
    ...
    public static void bookTicket(Passenger p) {
        if (upperList.size() == berthlimit && lowerList.size() == berthlimit && middleList.size() == berthlimit) {
            ...
            System.out.println(p.getPreference() + "  Ticket is not available");
            p.setId(p.getId() - 1);
            availableList();
        }
    }
    ...
    private static void availableList(){
        ...
        System.out.println("UpperBerth "+(berthlimit-upperList.size()));
        System.out.println("MiddleBerth "+(berthlimit-middleList.size()));
        System.out.println("LowerBerth "+(berthlimit-lowerList.size()));
    }
